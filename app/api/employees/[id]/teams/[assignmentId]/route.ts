...
/**
 * PATCH /api/employees/[id]/teams/[assignmentId]
 * Update team assignment (typically to set end date)
 * 
 * Request Body:
...
export const PATCH = createApiRoute({
  method: 'PATCH',
  path: '/api/employees/{id}/teams/{assignmentId}',
  summary: 'Update team assignment',
  description: 'Update team assignment (typically to set end date)',
  tags: ['Employees'],
  security: 'adminAuth',
  request: {
    params: z.object({
  ...
  handler: async ({ params, body }) => {
    ...
    try {
      ...
      console.error("[api/employees/[id]/teams/[assignmentId] PATCH]", err)
...
/**
 * DELETE /api/employees/[id]/teams/[assignmentId]
 * Remove team assignment (sets validTo to now)
 */
export const DELETE = createApiRoute({
  method: 'DELETE',
  path: '/api/employees/{id}/teams/{assignmentId}',
  summary: 'Remove team assignment',
  description: 'Remove team assignment (sets validTo to now)',
  tags: ['Employees'],
  security: 'adminAuth',
  request: {
    params: z.object({
  ...
  handler: async ({ params }) => {
    ...
    try {
      ...
      console.error("[api/employees/[id]/teams/[assignmentId] DELETE]", err)
