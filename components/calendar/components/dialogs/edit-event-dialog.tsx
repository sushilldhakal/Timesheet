...
import { editEventSchema } from "@/components/calendar/schemas";

import type { IEvent } from "@/components/calendar/interfaces";
import type { TimeValue } from "react-aria-components";
import type { TEditEventFormData } from "@/components/calendar/schemas";
...
export function EditEventDialog({ children, event }: IProps) {
  ...
  const form = useForm<TEditEventFormData>({
  ...
  const onSubmit = (values: TEditEventFormData) => {
    ...
    updateEvent({
      ...
      user,
      title: values.title || "",
      color: values.color || event.color,
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            This form only updates the current shift state locally for demonstration purposes. If you move a shift after editing, some inconsistencies may
