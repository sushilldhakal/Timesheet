...
// Back-compat constants used by some grid/layout helpers
export const DEFAULT_CELL_WIDTH = HOUR_W
export const DEFAULT_CELL_HEIGHT = SHIFT_H
export const DEFAULT_HEADER_HEIGHT = HOUR_HDR_H
export const DEFAULT_SIDEBAR_WIDTH = SIDEBAR_W

// Time unit helpers (used by some utils)
