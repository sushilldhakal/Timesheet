...
import { DragEngine, type DragEngineOptions, type DragCommit } from '@/components/scheduling/grid/dragEngine'
import { makeGridConfig } from '@/components/scheduling/grid/geometry'
import type { Block, Resource, Settings } from '@/components/scheduling/core/types-scheduler'
...
export function useDragEngine(
  ...
  const getOpts = useCallback((): DragEngineOptions => ({
    ...
    onHoverCategory,
       ...
       scrollRef, ghostRef, cursorGhostRef])
