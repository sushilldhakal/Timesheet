...
export function generateOnboardingEmail(data: OnboardingEmailData) {
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 30px 0; color: #374151; font-size: 16px; line-height: 1.6;">
                Your employee account has been successfully created. Below are your account details:
              </p>
                ...
                <tr>
                  <td style="padding: 20px;">
                    <table width="100%" cellpadding="8" cellspacing="0">
                      ...
                      <tr>
                        <td style="color: #6b7280; font-size: 14px; font-weight: 500;">PIN:</td>
                ...
                <tr>
                  <td style="padding: 16px 20px;">
                    <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 1.6;">
                      <strong>⚠️ Important:</strong> Please keep your PIN secure. You'll need it to clock in and out.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin: 0 0 20px 0; color: #374151; font-size: 16px; line-height: 1.6;">
                If you have any questions or need assistance, please contact your supervisor or HR department.
              </p>
...
⚠️ Important: Please keep your PIN secure. You'll need it to clock in and out.
